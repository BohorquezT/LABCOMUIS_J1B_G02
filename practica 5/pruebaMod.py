...
class pruebaMod(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "pruebaMod")
        ...
        self.blocks_delay_0_2 = blocks.delay(gr.sizeof_float*1, D3)
        ...
        self.analog_sig_source_x_0_2_0 = analog.sig_source_f(samp_rate, analog.GR_SAW_WAVE, 100, 1, 0, 0)
        self.analog_sig_source_x_0_2 = analog.sig_source_f(samp_rate, analog.GR_TRI_WAVE, 100, 1, 0, 0)
        self.analog_sig_source_x_0_1 = analog.sig_source_f(samp_rate, analog.GR_SQR_WAVE, 100, 1, 0, 0)
        ...
        self.ModuladorPAM_0_1_0 = ModuladorPAM(
            d=w,
            fs=fs,
            samp_rate=samp_rate,
        )
        ...
        self.connect((self.ModuladorPAM_0_1, 0), (self.blocks_delay_0_1, 0))
        self.connect((self.ModuladorPAM_0_1_0, 0), (self.blocks_delay_0_2, 0))
        ...
        self.connect((self.analog_sig_source_x_0_1, 0), (self.ModuladorPAM_0_0, 0))
        self.connect((self.analog_sig_source_x_0_2, 0), (self.ModuladorPAM_0_1, 0))
        self.connect((self.analog_sig_source_x_0_2_0, 0), (self.ModuladorPAM_0_1_0, 0))
        ...
        self.connect((self.blocks_delay_0_2, 0), (self.qtgui_freq_sink_x_0, 3))
        self.connect((self.blocks_delay_0_2, 0), (self.qtgui_time_sink_x_0, 3))
        self.connect((self.blocks_multiply_xx_1, 0), (self.qtgui_freq_sink_x_0, 4))
        self.connect((self.blocks_multiply_xx_1, 0), (self.qtgui_time_sink_x_0, 4))
    ...
    def set_fs(self, fs):
        ...
        self.ModuladorPAM_0_1_0.set_fs(self.fs)
    ...
    def set_w(self, w):
        ...
        self.ModuladorPAM_0_1_0.set_d(self.w)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.ModuladorPAM_0_1_0.set_samp_rate(self.samp_rate)
    ...
    def set_D3(self, D3):
        self.D3 = D3
        self.blocks_delay_0_2.set_dly(self.D3)
...
def main(top_block_cls=pruebaMod, options=None):
