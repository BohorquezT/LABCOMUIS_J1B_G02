...
class calc_pot(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "calc_pot")
        ...
        # Blocks
        ##################################################
        self._A_range = Range(1, 20, 1, 1, 200)
...
def main(top_block_cls=calc_pot, options=None):
