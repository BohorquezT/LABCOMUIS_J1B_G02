...
class DemoduladorFM(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Blocks
        ##################################################
        self._fc_range = Range(88000000, 108000000, 100000, 88.1e6, 200)
        ...
        self.connect((self.analog_wfm_rcv_1, 0), (self.analog_fm_preemph_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.qtgui_freq_sink_x_1.set_frequency_range(88100e3, self.samp_rate)
